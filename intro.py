...
# INDENTATION
# indetation is how define blocks of code
if 5 > 2: #first block 
    # nested, second block
...
in the beauty of their dreams. " the love
you have inside of me of you the log 
the love
"""

print(favorite_quote)

my_escaped_new = "Hello there, I hope \
you're \
doing  very well today!"

print (my_escaped_new)
...
number = input("Enter a number to be added to 10")
